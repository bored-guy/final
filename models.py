...
class Student(models.Model):
    ...
    if_email_xiwei = models.BooleanField(null=True, default=False, verbose_name="发送邮件确定席位，选择”是“后发送", choices=((0, "否"), (1, "是")))
    if_email_money = models.BooleanField(null=True, default=False, verbose_name="发送邮件确定缴费，选择”是“后发送",
                                         choices=((0, "否"), (1, "是")))
    def __str__(self):
        return self.name
...
class Team(models.Model):
    ...
    if_email_money = models.BooleanField(null=True, default=False, verbose_name="发送邮件确定缴费，选择”是“后发送", choices=((0, "否"), (1, "是")))
    if_email_fenpei = models.BooleanField(null=True, default=False, verbose_name="发送邮件分配名额，选择”是“后发送",
                                         choices=((0, "否"), (1, "是")))
    def __str__(self):
